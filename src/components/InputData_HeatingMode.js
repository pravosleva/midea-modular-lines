...
class InputParameters_HeatingMode extends Component {
  ...
  onChangeForm (propName, e) {
    let {
      ...
      //...
    } = this.props.obj.inputDataHeatingMode;
    ...
    this.props.updateInputParameters_HeatingMode({
      requiredCoolingCapacity,
      tExternal,
      tLiquidInlet, tLiquidOutlet,
      liquidType, percentage,
...
export default InputParameters_HeatingMode;
